...
for J in J_list:
    ...
    #NN_ParamImgs = np.load(f'Heisenberg_Qubits8_layer10_J{np.round(J, 2)}_h1-4_epoch501_test10_NN_ParamImgs.npy')
    ...
    #Heisenberg_NN_ParamImgs.append(NN_ParamImgs)
...
#Heisenberg_NN_ParamImgs_save = np.concatenate(Heisenberg_NN_ParamImgs, axis=0)
...
#np.save('allData_inFor/Heisenberg_Qubits8_layer10_J1-4_h1-4_epoch501_test10_NN_ParamImgs.npy', Heisenberg_NN_ParamImgs_save)
